...
const About = () => {
  ...
  return (
    <div className="font-satoshi">
      {/* section1 */}
      <div className="mx-4 md:mx-10  flex flex-col items-center gap-4 md:gap-8 text-center my-8 md:my-10">
        <h1 className="text-3xl md:text-6xl font-bold">
          About <span className="text-[#C17818]"> KD Sure</span>
        </h1>
        <p className="text-sm w-full md:w-2/3 md:text-base">
          Setting a realistic budget before looking for a home will help you
      ...
      {/* section2 */}
      <div className="mx-auto px-4 md:px-10 w-full my-10 md:my-20">
        {/* Grid Container for Statistics */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Statistic Item */}
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl font-bold text-[#C17818]">10K+</h2>
            <h3 className="text-base md:text-xl font-semibold text-[#727376] mt-2">
              Homes Purchased
            </h3>
            <p className="text-[#727376] text-[12px] md:text-sm mt-1">
              More than 10 thousand homes have been successfully purchased
              through our platform.
            </p>
          </div>
          {/* Statistic Item */}
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl font-bold text-[#C17818]">220K+</h2>
            <h3 className="text-base md:text-xl font-semibold text-[#727376] mt-2">
              Published Properties
            </h3>
            <p className="text-[#727376] text-[12px] md:text-sm mt-1">
              With a wide range of properties available, users can easily find
              property that fits their criteria.
            </p>
          </div>
          {/* Statistic Item */}
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl font-bold text-[#C17818]">360K+</h2>
            <h3 className="text-base md:text-xl font-semibold text-[#727376] mt-2">
              Active Users
            </h3>
            <p className="text-[#727376] text-[12px] md:text-sm mt-1">
              Our platform has helped thousands of people find their dream
              property, creating seamless experiences.
            </p>
          </div>
          {/* Statistic Item */}
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl font-bold text-[#C17818]">48+</h2>
            <h3 className="text-base md:text-xl font-semibold text-[#727376] mt-2">
              Countries Served
            </h3>
            <p className="text-[#727376] text-[12px] md:text-sm mt-1">
              We provide property search services that allow users to find
              properties in their various areas.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mt-10">
        {/* Section Header */}
        <div className="mx-4 md:mx-10 mb-8 flex flex-col gap-2">
          <h2 className="text-3xl md:text-6xl font-bold text-center md:text-start">
            Find your perfect <span className="text-[#c17818]">property</span>
          </h2>
          <div className="flex flex-col md:flex-row gap-4 md:gap-0 justify-between items-center">
            <p className="text-gray-600 text-center md:text-start text-base md:text-lg w-full md:w-2/3 mt-2">
              We offer a wide range of properties to suit your needs. Whether
              you are looking to buy, sell, or rent, we provide easy access to
              hundreds of available properties.
            </p>
            <div className="flex justify-between gap-6 items-center">
              <button
                onClick={prevSlide}
                className="p-3 bg-[#c17818] rounded-full text-white hover:bg-yellow-600"
              >
                <FaArrowLeft />
              </button>
              <button
  ...
  <div className="flex justify-between gap-6 mt-4 md:hidden">
    ...
    >
      ...
      <div className="flex flex-col items-center text-center mx-4 md:mx-10">
        <h1 className="text-3xl md:text-7xl font-semibold md:leading-[80px] ">
          Real Estate <span className="text-[#c17818]">Services</span> Tailored
          for You
        </h1>
      </div>
      ...
      <div className="w-full mb-28">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 mx-4 md:mx-10 mt-14">
          ...
          {/* Service Card 4 */}
          <div className="bg-[#f0f0f1] shadow-lg p-6 rounded-3xl border-[1.5px] border-[#c4c4c4] flex flex-col items-start">
            <div className=" text-4xl mb-4 flex gap-4 items-center">
              <svg
                width="40"
                height="40"
            ...
            <p className="text-gray-500 text-sm mt-2">
              Our experienced consultants provide expert advice to help you make
