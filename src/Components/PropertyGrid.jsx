...
const PropertyGrid = () => {
  return (
    <div className="w-full py-12 font-satoshi">
      <div className="flex justify-between items-end ">
        <div className="w-full flex-col flex mb-10">
          <h2 className="text-6xl font-semibold text-gray-900 text-left mb-4">
            Explore more property
          </h2>
          <div className="w-full flex justify-between ">
            <p className="text-gray-500 w-2/3  text-lg text-left ">
